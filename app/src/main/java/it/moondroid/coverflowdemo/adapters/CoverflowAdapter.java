...
import it.moondroid.coverflowdemo.models.GalleryEntity;

/**
 * Created by Nadzer on 13/03/2016.
 */
public class CoverflowAdapter extends BaseAdapter {
    private ArrayList<GalleryEntity> mData = new ArrayList<>(0);
    ...
    public void setData(ArrayList<GalleryEntity> data) {
        mData = data;
    }
